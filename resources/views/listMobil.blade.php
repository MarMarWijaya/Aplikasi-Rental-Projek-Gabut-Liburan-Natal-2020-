    ...
    <table class="table">
        ...
        @foreach($allMobil as $aM)
            <tr>
                ...
                <td><a href="/getMobilByID/{{$aM->idMobil}}"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSw6QedTNi-tUchlqiuTsPuDL5QDN-40nVbxg&usqp=CAU" width="20px"></a></td>
